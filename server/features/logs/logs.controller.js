...
import { initializeLogsTable } from './init-logs-table.service.js';
  ...
  try {
    ...
    if (env.DASHBOARD_DB && logData.campaignId && (logData.type === 'click' || logData.type === 'validation' || logData.type === 'disabled')) {
      try {
        ...
        const { updateCampaignTraffic } = await import('../campaigns/campaigns.controller.js');
                  ...
                  try {
                    ...
                    if (fullCampaign && fullCampaign.tiktok_store_id) {
                      ...
                      if (tiktokStore && tiktokStore.access_token) {
                        ...
                        const { updateTikTokPageContent } = await import('../campaigns/campaigns.controller.js');
                        ...
                        if (fullCampaign.redirect_type !== 'custom' && fullCampaign.redirect_store_id) {
                          try {
                            ...
                            const { createRedirectStoreOfferPage } = await import('../campaigns/campaigns.controller.js');
